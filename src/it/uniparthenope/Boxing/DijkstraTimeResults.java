...
//    private LinkedList<Double> partial_times;
    double[] partial_times;

//    public DijkstraTimeResults(double tdep_cost, LinkedList<Integer>  tdep_path, LinkedList<Double> tdep_partial_times){
//        this.cost = tdep_cost;
//        this.path = tdep_path;
...
//    public LinkedList<Double> getPartial_times() {
